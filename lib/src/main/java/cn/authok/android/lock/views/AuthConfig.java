...
public class AuthConfig {
    ...
    public String getName(@NonNull Context context) {
        ...
        int id = getIdForResource(context, R.attr.Authok_Name);
    ...
    public Drawable getLogo(@NonNull Context context) {
        @SuppressLint("ResourceType")
        int id = getIdForResource(context, R.attr.Authok_Logo);
        if (id == -1) {
            id = R.drawable.cn_authok_lock_ic_social_authok;
        }
    ...
    public int getBackgroundColor(@NonNull Context context) {
        @SuppressLint("ResourceType")
        int id = getIdForResource(context, R.attr.Authok_BackgroundColor);
        if (id == -1) {
            id = R.color.cn_authok_lock_social_unknown;
        }
