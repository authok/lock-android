...
public class AuthConfigTest {
    ...
    public void shouldGetName() {
        ...
        final String string = RuntimeEnvironment.application.getResources().getString(R.string.cn_authok_lock_social_facebook);
    ...
    public void shouldGetLogo() {
        ReflectionHelpers.setStaticField(Build.VERSION.class, "SDK_INT", Build.VERSION_CODES.JELLY_BEAN);
        Drawable drawable1 = RuntimeEnvironment.application.getResources().getDrawable(R.drawable.cn_authok_lock_ic_social_facebook);
    ...
    public void shouldGetBackgroundColor() {
        ReflectionHelpers.setStaticField(Build.VERSION.class, "SDK_INT", Build.VERSION_CODES.JELLY_BEAN);
        final int color = RuntimeEnvironment.application.getResources().getColor(R.color.cn_authok_lock_social_facebook);
    ...
    public void shouldHaveValidDefaultLogo() {
        ReflectionHelpers.setStaticField(Build.VERSION.class, "SDK_INT", Build.VERSION_CODES.JELLY_BEAN);
        AuthConfig defaultConfig = new AuthConfig(connection, R.style.Lock_Theme);
        Drawable drawable1 = RuntimeEnvironment.application.getResources().getDrawable(R.drawable.cn_authok_lock_ic_social_authok);
    ...
    public void shouldHaveValidDefaultColor() {
        ReflectionHelpers.setStaticField(Build.VERSION.class, "SDK_INT", Build.VERSION_CODES.JELLY_BEAN);
        AuthConfig defaultConfig = new AuthConfig(connection, R.style.Lock_Theme);
        final int color = RuntimeEnvironment.application.getResources().getColor(R.color.cn_authok_lock_social_unknown);
