...
import cn.authok.android.lock.internal.configuration.PasswordlessConnection;
...
public class PasswordlessLockActivityTest {
    ...
    public void setUp() {
        ...
        when(options.getAccount()).thenReturn(new Authok("cliendId", "domain"));
    ...
    public void shouldCallOAuthAuthenticationWithCustomProviderAndAudience() {
        Authok account = new Authok("cliendId", "domain");
