...
public class LoginErrorMessageBuilderTest {
    ...
    public void shouldHaveDefaultMessageIfAccessDenied() {
        ...
        assertThat(error.getMessageRes(), is(equalTo(R.string.cn_authok_lock_db_login_error_message)));
    }
    ...
    public void shouldHaveCustomMessageIfInvalidCredentials() {
        ...
        final AuthenticationError error = builder.buildFrom(exception);
        assertThat(error.getMessageRes(), is(equalTo(R.string.cn_authok_lock_db_login_error_invalid_credentials_message)));
    }
    ...
    public void shouldHaveDescriptionIfRuleError() {
        ...
        final AuthenticationError error = builder.buildFrom(exception);
        assertThat(error.getMessageRes(), is(R.string.cn_authok_lock_db_login_error_unauthorized_message));
    ...
    public void shouldHaveCustomMessageIfPasswordLeaked() {
        ...
        final AuthenticationError error = builder.buildFrom(exception);
        assertThat(error.getMessageRes(), is(equalTo(R.string.cn_authok_lock_db_password_leaked_error_message)));
    }
    ...
    public void shouldHaveCustomMessageIfMultifactorCodeInvalid() {
        ...
        final AuthenticationError error = builder.buildFrom(exception);
        assertThat(error.getMessageRes(), is(equalTo(R.string.cn_authok_lock_db_login_error_invalid_mfa_code_message)));
    }
    ...
    public void shouldHaveDefaultMessageIfMultifactorEnrollRequired() {
        ...
        final AuthenticationError error = builder.buildFrom(exception);
        assertThat(error.getMessageRes(), is(equalTo(R.string.cn_authok_lock_db_login_error_mfa_enroll_required)));
    }
    ...
    public void shouldHaveCustomMessageIfUsernameExists() {
        ...
        assertThat(error1.getMessageRes(), is(equalTo(R.string.cn_authok_lock_db_signup_user_already_exists_error_message)));

        Mockito.when(exception.getCode()).thenReturn("username_exists");
        final AuthenticationError error2 = builder.buildFrom(exception);
        assertThat(error2.getMessageRes(), is(equalTo(R.string.cn_authok_lock_db_signup_user_already_exists_error_message)));
    }
    ...
    public void shouldHaveCustomMessageIfUserIsBlocked() {
        ...
        final AuthenticationError error = builder.buildFrom(exception);
        assertThat(error.getMessageRes(), is(equalTo(R.string.cn_authok_lock_db_login_error_unauthorized_message)));
    }
    ...
    public void shouldHaveCustomMessageIfIsTooManyAttempts() {
        ...
        final AuthenticationError error = builder.buildFrom(exception);
        assertThat(error.getMessageRes(), is(equalTo(R.string.cn_authok_lock_db_too_many_attempts_error_message)));
    }
