...
public class SignUpErrorMessageBuilderTest {
    ...
    public void shouldHaveDefaultMessageIfAccessDenied() {
        ...
        assertThat(error.getMessageRes(), is(equalTo(R.string.cn_authok_lock_db_sign_up_error_message)));
    }
    ...
    public void shouldHaveDescriptionIfRuleError() {
        ...
        final AuthenticationError error = builder.buildFrom(exception);
        assertThat(error.getMessageRes(), is(R.string.cn_authok_lock_db_sign_up_error_message));
    ...
    public void shouldHaveCustomMessageIfPasswordNotStrongEnough() {
        ...
        final AuthenticationError error = builder.buildFrom(exception);
        assertThat(error.getMessageRes(), is(equalTo(R.string.cn_authok_lock_db_signup_password_not_strong_error_message)));
    }
    ...
    public void shouldHaveCustomMessageIfPasswordAlreadyUsed() {
        ...
        final AuthenticationError error = builder.buildFrom(exception);
        assertThat(error.getMessageRes(), is(equalTo(R.string.cn_authok_lock_db_signup_password_already_used_error_message)));
    }
}