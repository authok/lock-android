...
import cn.authok.android.lock.UsernameStyle;
import cn.authok.android.lock.utils.CustomField;
import cn.authok.android.lock.utils.CustomField.FieldType;
import cn.authok.android.lock.utils.SignUpField;
...
public class OptionsTest {
    ...
    private static final String DOMAIN = "https://my-domain.cn.authok.cn";
    private static final String CONFIG_DOMAIN = "https://my-cdn.cn.authok.cn";
    ...
    public void setUp() {
        options = new Options();
        options.setAccount(new Authok(CLIENT_ID, DOMAIN, CONFIG_DOMAIN));
    }
    ...
    public void shouldSetCustomTheme() {
        Theme theme = Theme.newBuilder()
                .withHeaderTitle(R.string.cn_authok_lock_header_title)
                .withHeaderLogo(R.drawable.cn_authok_lock_header_logo)
                .withHeaderColor(R.color.cn_authok_lock_social_unknown)
                .withHeaderTitleColor(R.color.cn_authok_lock_social_unknown)
                .withPrimaryColor(R.color.cn_authok_lock_social_unknown)
                .withDarkPrimaryColor(R.color.cn_authok_lock_social_unknown)
                .build();
    ...
    public void shouldSetAudience() {
        options.withAudience("https://domain.authok.cn/users");
        ...
        Options parceledOptions = Options.CREATOR.createFromParcel(parcel);
        assertThat(options.getAudience(), is(equalTo("https://domain.authok.cn/users")));
        assertThat(parceledOptions.getAudience(), is("https://domain.authok.cn/users"));
    }
    ...
    public void shouldSetScheme() {
        ...
        Options parceledOptions = Options.CREATOR.createFromParcel(parcel);
        assertThat(options.getScheme(), is(equalTo("authok")));
        assertThat(parceledOptions.getScheme(), is("authok"));
    }
    ...
    private List<SignUpField> createCustomFields() {
        CustomField fieldNumber = new CustomField(R.drawable.cn_authok_lock_ic_phone, FieldType.TYPE_PHONE_NUMBER, "number", R.string.cn_authok_lock_hint_phone_number);
        CustomField fieldSurname = new CustomField(R.drawable.cn_authok_lock_ic_username, FieldType.TYPE_NAME, "surname", R.string.cn_authok_lock_hint_username);
